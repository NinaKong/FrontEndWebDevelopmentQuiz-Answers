...
- Does css properties are case sensitive? 
  ...
  All CSS syntax is case-insensitive
  
- Does margin-top or margin-bottom has effect on inline element? 
  Answer: False
  
  An inline element still receive padding and margin, however, it is working as inline, so it will only work for horizontal, not vertical way. It will not receive margin-top, margin-bottom, padding-left, padding-bottom, width, and height. 
